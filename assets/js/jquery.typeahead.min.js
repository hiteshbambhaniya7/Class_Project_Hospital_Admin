    ...
    generateSource: function (t) {
      ...
      for (
        ...
        if (
          ...
          (r = o.compression),
          this.options.asyncResult && delete this.source[i],
    ...
    incrementGeneratedGroup: function (t) {
      if (
        ...
        for (var e = 0, i = this.generateGroups.length; e < i; e++)
          this.source[this.generateGroups[e]] =
            this.tmpSource[this.generateGroups[e]];
  ...
  var e = {
    typeahead: function (t, e) {
      if (e && e.source && "object" == typeof e.source) {
        ...
        if (t.length) {
          if (
            (void 0 === t[0].value && (t[0].value = t.text()), 1 === t.length)
          )
            return (
              (t[0].selector =
                t.selector || e.input || t[0].nodeName.toLowerCase()),
              (window.Typeahead[t[0].selector] = new r(t, e))
            );
          for (var i, s = {}, o = 0, n = t.length; o < n; ++o)
            void 0 !== s[(i = t[o].nodeName.toLowerCase())] && (i += o),
              (t[o].selector = i),
              (window.Typeahead[i] = s[i] = new r(t.eq(o), e));
          return s;
        }
      }
    },
